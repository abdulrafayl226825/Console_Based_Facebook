...
//	{
//		if (temp1.date == date && temp1.month == month )
//			return 1;
//		return 0;
//	}
...
//	{
//		if (date == rhcc.date&&month==rhcc.month)
//		{
...
//		}
//	}
//	virtual void Print(bool flag =true,bool flag2=true )
//	{
//		cout << "-----------------------------------------------------------------" << endl;
//		cout << endl;
//		SharedBy->printname();
...
//		for (int i = 0; i < postcount; i++)
//		{
//			if (PostTimeLine[i]->GetDate().Compare(Date::currentDate))
//			{
//				cout << "On this Day ";
//				cout << PostTimeLine[i]->GetDate().DateDifferences(Date::currentDate);
//				cout << " Years Ago " <<endl;
//				PostTimeLine[i]->Print();
//			}
//		}
...
//		ptr->viewLikedBy();
//	}
//	void LikePost(const char* PostId, User*& currentUser)
//	{
//		Post* post = SearchPostById(PostId);
//		post->SetLikedBy(currentUser);
//	}
//	void SeeYourMemory(User*& currentUser)
//	{
//		currentUser->SeeMom0ry();
//	
//	}
...
//	    Post*	post = SearchPostById(PostId);
//		currentUser->SharedMemory(Text, post);
//	}
//	void PostComment(const char* PostId, const char* CommentText, User*& currentUser)
//	{
//		Post *Postptr = SearchPostById(PostId);
//		Postptr->AddComment(currentUser,(char*) CommentText);
//	}
...
//	PostComment("post4", "tou kadi pass ni hona ", currentUser);
//	ViewPost("post4");
//	cout << "\n-----------------------------------------------------------------------------------------\n";
